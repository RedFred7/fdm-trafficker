...
describe RegionFinder do
  ...
  before :each do
    ...
    stub_request(:get, "http://mapit.mysociety.org/postcode/222").
      with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Host'=>'mapit.mysociety.org', 'User-Agent'=>'Ruby'}).
